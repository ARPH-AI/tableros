        ...
        <form class="mt-6 mb-4 md:hidden">
          <div class="pt-0 mb-3">
            <input
              type="text"
              placeholder="Search"
              class="px-3 py-2 w-full h-12 text-base font-normal leading-snug bg-white rounded border-0 border-solid shadow-none outline-none  border-blueGray-500 placeholder-blueGray-300 text-blueGray-600 focus:outline-none"
            />
          </div>
        </form>
